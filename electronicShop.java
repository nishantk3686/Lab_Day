...
public class electronicShop {
	...
	public static void main(String[] args) {
		...
		product p1=new product (1001,"Lenavo","Ideapad 5",72998,2021);
		...
		p.stream().filter(pro->pro.pPrice<30000).
		forEach(pro->{
		System.out.println(pro.pBrand+" "+pro.pName+" For Rs. "+pro.pPrice+" Built in "+pro.pBuiltYear);});
